...
console.log(chalk.red('=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+='))
  console.log(chalk.cyan(`Made by Akg#2349`))
  console.log(chalk`{yellowBright Youtube } | {blueBright Aktheduck} | {cyanBright https://www.youtube.com/channel/UCHGkd9WYJyaa-eY8i5izbkg}`)
  console.log(chalk`{yellowBright Discord } | {blueBright Akg#2349} | {cyanBright https://dsc.gg/aktheduck}`)
...
.addField(`My Source Code`, `[Click Me!](https://github.com/TajuModding/Discord-v13-Button-Tickets-bot)`, false)
  ...
  if (command == prefix + 'setstaff'){
    ...
    message.react("887553038020124712")
  }
...
<:trash:891558611086622761>`)
        
        let bu1tton = new Discord.MessageButton()
          .setStyle(`SECONDARY`)
          .setLabel('Close')
          .setCustomId(`cl`)
          .setEmoji(`891558611086622761`)
